...
if __name__ == "__main__":  
    ...
    source = f"{script_dir}/CaptainNerfs/BepInEx/config/Obeliskial_importing/"    
    version = "CaptainNerfsOP"
    destination = f"{bepinex_dir}/config/Obeliskial_importing"
    copy_directory(source, destination)
    # version = "CaptainNerfsBalanced"
    # destination = f"{bepinex_dir}/config/Obeliskial_importing/{version}"
    # copy_directory(source, destination)
    # version = "CaptainNerfsEarly"
    # destination = f"{bepinex_dir}/config/Obeliskial_importing/{version}"    
    # copy_directory(source, destination)
